  ...
  return (
    <footer className="bg-white border-t-[6px] border-[#c8102e] pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-6 lg:px-20 relative">
        ...
        <a href="https://wa.me/917758855308" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 w-12 h-12 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-xl hover:scale-110 transition-transform z-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0 items-start">
          ...
          <div className="flex flex-col pr-8">
            ...
            <div className="flex items-center gap-3">
              <a href="https://x.com/cpcrindia?s=21" className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-[#c8102e] hover:bg-red-50 transition-colors">
          ...
          <div className="flex flex-col lg:pl-10">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-gray-500 text-[15px] font-medium">
                ...
                <a href="tel:+917758855308" className="hover:text-[#c8102e] transition-colors">+91 7758855308</a>
              </li>
              <li className="flex items-center gap-3 text-gray-500 text-[15px] font-medium">
                <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center shrink-0">
                  <svg className="w-3.5 h-3.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
