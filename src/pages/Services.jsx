...
export default function Services() {
  ...
  return (
    <main className="font-sans bg-white text-gray-900 pb-20 selection:bg-[#c8102e] selection:text-white">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 lg:p-10">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-6xl max-h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row z-10 border border-white/20"
            >
              <button 
                onClick={() => setSelectedProject(null)}
                className="absolute top-6 right-6 w-12 h-12 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-xl text-white flex items-center justify-center z-20 transition-all border border-white/20 group"
              >
              ...
              <div className="w-full md:w-1/2 p-10 md:p-16 overflow-y-auto bg-white flex flex-col">
                ...
                <div className="border-t border-gray-100 pt-10 flex-grow">
                  <h4 className="text-gray-900 font-bold text-xl mb-6 flex items-center gap-3">
                ...
                <div className="pt-10 mt-auto">
                  <button 
                    onClick={() => setSelectedProject(null)}
                    className="w-full bg-gray-900 text-white font-bold py-5 rounded-2xl hover:bg-[#c8102e] transition-all flex items-center justify-center gap-3 group shadow-xl"
                  >
                    Close Project
                    <svg className="w-5 h-5 transform group-hover:scale-125 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </button>
                </div>
      ...
      {/* Hero Section (Matching About.jsx style) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { 
                ...
                desc: 'Door-to-door and booth-level surveys to capture real voter sentiment and local issues.', 
                icon: 'M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z'
              },
              { 
                title: 'Political Research', 
                desc: 'In-depth constituency analysis, caste dynamics, issue mapping, and electoral trend studies.', 
                icon: 'M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z'
              },
              { 
                title: 'Voter Data Analysis', 
                desc: 'Transforming raw data into actionable insights using structured analytics.', 
              ...
              { 
                ...
                desc: 'Strategic planning based on real data to improve outreach, messaging and voter targeting.', 
                icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z'
              }
            ].map((service, i) => (
              <div key={i} className="bg-white p-10 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 flex flex-col items-center text-center transition-transform hover:-translate-y-1">
