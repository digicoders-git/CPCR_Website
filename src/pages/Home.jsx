    ...
    <main className="font-sans bg-white text-gray-900">
      ...
      <section className="bg-white pb-20">
        <div className="bg-[#c8102e] py-8 px-6 text-center text-white shadow-md">
          ...
          <p className="text-red-50 text-lg md:text-xl font-medium max-w-3xl mx-auto">Scientific Survey Research for Constituency-Level decision support</p>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 flex flex-col gap-10">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
            <div className="w-full lg:w-1/2 flex flex-col space-y-6 text-gray-700 text-base leading-relaxed font-medium">
              ...
              <p>Survey outputs can reveal caste and community dynamics, panchayat-wise winnability, male-female voter ratios, and opponent strongholds. These insights help leaders finalize a clear, data-driven election strategy.</p>
            </div>
            <div className="w-full lg:w-1/2 flex flex-col space-y-6">
              <div className="bg-[#f8faff] border border-blue-100 rounded-2xl p-6 shadow-sm">
                ...
                <ul className="space-y-3">
                  {['Caste & community dynamics', 'Male-Female voter ratio', 'Panchayat-wise representation', 'Balanced demographic sampling'].map((item, i) => (
              ...
              <div className="bg-[#f8faff] border border-blue-100 rounded-2xl p-6 shadow-sm">
                ...
                <ul className="space-y-3">
                  {['Panchayat-wise winnability', 'Caste-wise support / voter inclination', 'Opponent\'s strong Panchayats & communities', 'Overall winnability & key focus areas'].map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-gray-800 mt-2.5 shrink-0"></div>
                      <span className="text-gray-800 font-medium">{item}</span>
                    </li>
          ...
          <div className="w-full pt-8 border-t border-gray-100">
            <div className="flex flex-wrap items-center justify-center gap-3 text-center">
              {['Accurate Ground Data', 'Clear Strategy', 'Focused Campaign', 'Electoral Advantage'].map((text, i, arr) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  {i < arr.length - 1 && <span className="text-gray-400 font-bold sm:hidden">&rarr;</span>}
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="bg-[#f8faff] pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">A structured quantitative workflow from sampling to validated insight</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
            {[
              { title: 'COLLATING CASTE & DEMOGRAPHY DATA', sub: 'RETRO DATA ANALYSIS', desc: 'Analysis of the last three election results is conducted to derive caste-wise and demographic insights. This forms the foundation for accurate voter profiling at the Assembly Constituency.', icon: (
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" /></svg>
              )},
              { title: 'DATA COLLECTION (FIELD & CATI)', sub: '', desc: 'Voter opinions are collected through a mix of field surveys and CATI calling. Ensures coverage across diverse voter segments and geographic regions.', icon: (
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
              )},
              { title: 'INFLUENCER CALLING', sub: '', desc: 'Key stakeholders at village and block levels are interviewed. Provides insights on influence patterns, local demands, and ground narratives.', icon: (
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
              )},
              { title: 'RANDOM STRATIFIED SAMPLING', sub: '', desc: 'A scientifically stratified sample (2000-3000 respondents per AC). Based on age, gender, caste, and demographics for balanced representation.', icon: (
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
              )},
              { title: 'DATA VERIFICATION', sub: '', desc: '25% of collected data is verified within 24 hours. Conducted through a dedicated calling team to ensure accuracy.', icon: (
              ...
              { title: 'DATA ANALYSIS, NORMALISATION & REPORTING', sub: '', desc: 'Data is analysed across multiple parameters and normalised. Delivered in a clear, decision-ready format for strategic use.', icon: (
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              )}
            ].map((card, i) => (
              <div key={i} className="bg-white border-[1.5px] border-[#c8102e] rounded-xl p-6 shadow-sm flex flex-col hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4 mb-4">
                  <div className="text-[#c8102e]">{card.icon}</div>
                  <div>
                    <h3 className="text-[#c8102e] font-bold text-[13px] uppercase leading-tight">{card.title}</h3>
                    {card.sub && <p className="text-gray-500 text-[10px] font-bold uppercase">{card.sub}</p>}
                  </div>
                </div>
                <div className="border-b border-gray-100 mb-4"></div>
                <p className="text-gray-700 text-sm font-medium leading-relaxed">{card.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white pb-20 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">Understanding the motivations behind voter behavior</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          <div className="w-full lg:w-1/2 flex flex-col space-y-8 text-gray-700 text-base leading-relaxed font-medium">
            <p>Qualitative research is the most effective tool to understand the real on-ground sentiments, perceptions, and lived experiences of stakeholders.</p>
            <p>Our qualitative surveys help uncover deep-rooted issues, motivations, and behavioral drivers that quantitative data alone cannot capture. These insights play a critical role in shaping clear, evidence-based strategies and informed decision-making.</p>
            <div className="bg-[#f8faff] border border-blue-100 rounded-2xl p-6 shadow-sm">
              <h3 className="text-gray-900 text-[15px] font-bold mb-4 uppercase tracking-wide">QUALITATIVE REPORT HELPS YOU UNDERSTAND</h3>
              <ul className="space-y-3">
                {['Community perceptions & local issue priorities', 'Stakeholder attitudes & behavioral patterns', 'Influence networks & opinion leaders', 'Area / group-wise sentiment strength', 'Risk zones, opportunity areas & focus segments'].map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-gray-800 mt-2.5 shrink-0"></div>
                    <span className="text-gray-800 font-medium">{item}</span>
                  </li>
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-[#f8faff] border border-blue-100 rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-6">
                {[
                  { title: 'Open-Ended Interactions', pts: ['One-to-one, conversational engagements'] },
                  { title: 'Focus Group Discussions (FGDs)', pts: ['Moderated group discussions'] },
                  { title: 'Key Informant Interviews (KIIs)', pts: ['Interviews with experts, leaders & stakeholders', 'High-value, experience-driven insights'] },
                  { title: 'Exploratory Issue Mapping', pts: ['Identification of emerging, hidden & sensitive issues', 'Helps structure themes before large-scale studies'] }
                ].map((item, i) => (
                  <div key={i}>
      ...
      <section className="bg-gray-50 pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">Fast, scalable voter intelligence through direct contact</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            ...
            {[
              { step: '1', title: 'TARGETED VOTER CALLING', desc: 'Voters across all Assembly Constituencies were called, focusing on demographic mix & electoral importance' },
              { step: '2', title: 'DETAILED SURVEY QUESTIONNAIRE', desc: 'Structured questions were designed to gather insight on current issues, candidate preferences and undecided voter stance' },
              { step: '3', title: 'DATA ANALYSIS & INSIGHT', desc: 'Collected feedback was rigorously analyzed to identify voting patterns, key concerns, and areas for candidate positioning' },
              { step: '4', title: 'STRATEGIC REPORT & ACTION PLAN', desc: 'Findings were compiled into a detailed report with actionable recommendations.' }
            ].map((card, i) => (
              <div key={i} className="bg-white border-[1.5px] border-[#c8102e] rounded-xl p-6 shadow-sm flex flex-col items-center text-center relative z-10 hover:shadow-md transition-shadow">
                <div className="w-8 h-8 rounded-full bg-white text-[#c8102e] font-bold flex items-center justify-center border border-[#c8102e] absolute -top-4">{card.step}</div>
                ...
                <p className="text-gray-700 text-sm font-medium leading-relaxed text-left w-full">{card.desc}</p>
              </div>
            ))}
          </div>
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 text-center">
              {['Voter Trends Identified', 'Key Issues Highlighted', 'Tactical Actions Implemented'].map((text, i, arr) => (
                <div key={i} className="flex items-center gap-3">
                  <span className="text-gray-800 font-semibold text-[15px]">{text}</span>
                  {i < arr.length - 1 && <span className="text-gray-400 font-bold">&rarr;</span>}
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="bg-white pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">Strategic narrative control and digital influence across the campaign lifecycle</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 text-center">
          <h3 className="text-gray-900 font-bold text-2xl mb-6 flex items-center justify-center gap-4">
            <span className="h-px bg-gray-300 flex-1 hidden md:block max-w-[200px]"></span>Core Philosophy<span className="h-px bg-gray-300 flex-1 hidden md:block max-w-[200px]"></span>
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
             {[
               { step: '1', title: 'DAILY CREATIVE STRATEGY', pts: ['Vision-driven and positive storytelling', 'Issue-based & counter-narrative content', 'Platform-optimized designs for maximum reach'] },
               { step: '2', title: 'VIDEO CONTENT ENGINE', pts: ['Short-form videos (Reels / Shorts)', 'Clips from speeches, events & public interactions', 'Professionally edited with captions & audio cues'] },
               { step: '3', title: 'CONTENT DISTRIBUTION SYSTEM', pts: ['Multi-platform dissemination (FB, Insta, X)', 'Strong WhatsApp network integration', 'Time-optimized posting for peak engagement'] },
               { step: '4', title: 'SOCIAL MEDIA MANAGEMENT', pts: ['End-to-end handle management', 'Real-time monitoring & response strategy', 'WhatsApp broadcast & group ecosystems'] },
               { step: '5', title: 'INFLUENCER & NETWORK ECOSYSTEM', pts: ['Local digital influencer coordination', 'Support page & ecosystem', 'Amplification through trusted voices'] }
             ].map((card, i) => (
                <div key={i} className="bg-white border-[1.5px] border-[#c8102e] rounded-xl p-5 shadow-sm flex flex-col items-center text-center relative hover:shadow-md transition-shadow">
                  <div className="w-6 h-6 rounded-full bg-white text-[#c8102e] font-bold flex items-center justify-center border border-[#c8102e] absolute -top-3 text-xs">{card.step}</div>
                  <div className="text-[#c8102e] mb-3 mt-3">
                     <svg className="w-12 h-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
                  </div>
      ...
      <section className="bg-[#f8faff] pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">A phased plan for voter engagement and persuasion</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 text-center">
          <h3 className="text-[#c8102e] font-bold text-[16px] uppercase tracking-wide mb-4">TARGETED, PHASED OUTREACH ENSURES EFFECTIVE VOTER ENGAGEMENT</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
             ...
             {[
               { step: '1', title: 'BUILD ANTI-INCUMBENCY', pts: ['Identifying & amplifying local issues', 'Mobilizing discontent against the incumbent', 'Framing a winning narrative to unsettle the opposition'] },
               { step: '2', title: 'EXECUTE OUTREACH PROGRAM', pts: ['Executing door-to-door, public meetings, & small group mobilizations', 'Utilizing trained field teams for direct voter interaction', 'Gathering actionable voter data & insights'] },
               { step: '3', title: 'DELIVER CORE MESSAGE', pts: ['Communicating key campaign messages', 'Addressing local concerns & aspirations', 'Providing a compelling vision for the future'] }
             ].map((card, i) => (
                <div key={i} className="bg-[#fcf5f5] border-[1.5px] border-[#c8102e]/40 rounded-xl p-6 shadow-sm flex flex-col items-center text-center relative z-10">
                  <div className="w-8 h-8 rounded-full bg-white text-[#c8102e] font-bold flex items-center justify-center border border-[#c8102e] absolute -top-4 shadow-sm">{card.step}</div>
      ...
      <section className="bg-white pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">From planning and logistics to real-time monitoring and crisis response</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative">
             {[
               { step: '1', title: 'CAMPAIGN PLANNING', pts: ['Detailed electoral roadmap for the campaign', 'Setting clear objectives and milestones'] },
               { step: '2', title: 'RESOURCE COORDINATION', pts: ['Managing finances, manpower, logistics, and tech support', 'Ensuring optimal allocation and oversight'] },
               { step: '3', title: 'FIELD TEAM MANAGEMENT', pts: ['Deploying and supervising local teams & cadres', 'Mobilizing grassroots workers for on-ground activities'] },
               { step: '4', title: 'CRISIS & PR MANAGEMENT', pts: ['Managing media and controlling narratives, and addressing opposition attacks'] },
               { step: '5', title: 'REAL-TIME MONITORING & FEEDBACK', pts: ['Continuous monitoring of campaign activities', 'Detailed tracking, reporting and feedback systems'] }
             ].map((card, i) => (
                <div key={i} className="bg-white border-[1.5px] border-[#c8102e] rounded-xl p-5 shadow-sm flex flex-col items-center text-center relative hover:shadow-md transition-shadow">
                  <div className="w-8 h-8 rounded-full bg-white text-[#c8102e] font-bold flex items-center justify-center border border-[#c8102e] absolute -top-4 text-sm">{card.step}</div>
                  <div className="text-[#c8102e] mb-4 mt-4">
                     <svg className="w-14 h-14 mx-auto" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
                  </div>
      ...
      <section className="bg-[#f8faff] pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">Sharper targeting through voter-type specific messaging</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 text-center relative overflow-hidden pb-10">
          <div className="relative max-w-5xl mx-auto">
            <div className="hidden lg:flex absolute inset-0 items-center justify-center pointer-events-none opacity-20">
               <svg viewBox="0 0 500 200" className="w-[600px] h-[250px]"><ellipse cx="250" cy="100" rx="200" ry="80" fill="none" stroke="#6b7280" strokeWidth="2" strokeDasharray="5,5"/><ellipse cx="250" cy="100" rx="150" ry="60" fill="none" stroke="#6b7280" strokeWidth="3"/><ellipse cx="250" cy="100" rx="100" ry="40" fill="none" stroke="#6b7280" strokeWidth="4"/><ellipse cx="250" cy="100" rx="50" ry="20" fill="none" stroke="#6b7280" strokeWidth="5"/></svg>
            </div>
              ...
              <div className="flex flex-col gap-12 items-center md:items-end">
                <div className="flex flex-col items-center md:items-end text-center md:text-right max-w-[280px]">
                  <div className="w-24 h-24 rounded-full border-[3px] border-[#c8102e] bg-white flex items-center justify-center text-[#c8102e] shadow-sm mb-4">
                     <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01" /></svg>
                  </div>
      ...
      <section className="bg-white pb-24 border-t border-gray-100">
        <div className="bg-[#c8102e] py-8 px-6 text-white shadow-md text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-red-50 text-lg md:text-xl font-medium opacity-90">Targeted messaging across SMS, IVRS, WhatsApp, rich media</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-16 text-center">
          <h3 className="text-gray-900 font-bold text-[16px] uppercase tracking-wide mb-12">TARGETED POLITICAL MESSAGING ACROSS DIGITAL PLATFORMS</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             {[
               { icon: (<svg className="w-16 h-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}><rect x="3" y="4" width="18" height="16" rx="2" ry="2"></rect><path d="M16 2v4M8 2v4M3 10h18"></path><path d="M3 10l9 6 9-6" strokeWidth="1.5"></path></svg>), title: 'SMS TEXT', desc: 'Reach voters directly with targeted SMS alerts' },
               { icon: (<svg className="w-16 h-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /><path strokeLinecap="round" strokeLinejoin="round" d="M8 8h8M8 12h8" /></svg>), title: 'IVRS', desc: 'Interactive voice response for specific voter interactions' },
               { icon: (<svg className="w-16 h-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>), title: 'BULK WHATSAPP', desc: 'Broadcast messages to groups for engagement' },
               { icon: (<svg className="w-16 h-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" /></svg>), title: 'AI AUDIO/VIDEO MESSAGES', desc: 'AI-generated voice or video messages at scale' }
             ].map((card, i) => (
                <div key={i} className="bg-white border-[1.5px] border-[#c8102e]/30 rounded-xl p-6 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
                  <div className="text-[#c8102e] mb-6">{card.icon}</div>
